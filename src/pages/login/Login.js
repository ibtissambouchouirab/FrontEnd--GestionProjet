    ...
    render() {
        ...
        return (
            <div className="auth-page">
                    ...
                    <Widget className="widget-auth mx-auto" title={<h2 className="mt-0">Login</h2>}>
                        ...
                        <form onSubmit={this.doLogin}>
                            ...
                            <div className="bg-widget auth-widget-footer">
                                <Button type="submit" outline color="danger" className="auth-btn"  style={{color: '#fff' , size:'25px'}}>
                ...
                {new Date().getFullYear()} &copy;  React Admin Dashboard Template Made by <a href="https://github.com/bouchouirabI" rel="noopener noreferrer" target="_blank">ibtissam bouchouirab </a>.
                </footer>
            </div>
        );
    }
